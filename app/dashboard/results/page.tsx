...
function ResultsContent() {
      ...
      try {
        if (ideaId) {
          ...
          if (!storedResults && !storedIdea) {
            setLoadError(
              "No analysis results found. Please submit a startup idea first."
            );
          } else {
  ...
  const generatePDF = () => {
    ...
    doc.text("Startup Idea Analysis Report", pageWidth / 2, 20, {
      align: "center",
    });
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        [
          ...
          getScoreInterpretation(
            results.score.technicalFeasibility,
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        [
          ...
          "Good foundation with important hurdles",
        ],
        [
          "61-80",
          "Strong Potential",
          "Well-positioned with minor refinements needed",
        ],
        [
          "81-100",
          "Exceptional Opportunity",
          "Excellent market-fit with high chances of success",
        ],
      ],
      theme: "grid",
      styles: { fontSize: 8 },
    ...
    doc.save(
      `startup-analysis-${idea.title.replace(/\s+/g, "-").toLowerCase()}.pdf`
    );
  };
            ...
            {activeSection === "scores" && (
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {["overall", "marketPotential", "technicalFeasibility"].map(
                    (type) => (
                      <div
                        key={type}
                          ...
                          <div className="flex justify-center">
                            <div className="w-32 h-32">
                              <CircularProgressbar
                                ...
                                styles={buildStyles({
                                  pathColor: `rgba(16, 185, 129, ${
                                    results.score[type as keyof Score] / 100
                                  })`,
                                  textColor: "#fff",
              ...
              >
                ...
                {swotView === "grid" ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {Object.entries(results.swotAnalysis).map(
                      ([category, items]) => (
                        <div
                          key={category}
                ...
                <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700/50">
                      ...
                      {[
                        ...
                        >
                          ...
                          <div className="text-2xl font-bold text-emerald-400">
                            {results.score[type as keyof Score]}
                          </div>
                          <ScoreInterpretation
                            score={results.score[type as keyof Score]}
                            type={type as keyof Score}
                  ...
                  <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="p-4 bg-gray-700/20 rounded-lg">
                        ...
                        <p className="text-gray-300 font-medium">
                          {results.marketAnalysis.targetMarket}
                        </p>
                      </div>
                      <div className="p-4 bg-gray-700/20 rounded-lg">
                        <p className="text-sm text-gray-400">Growth Rate</p>
                        <p className="text-gray-300 font-medium">
                          {results.marketAnalysis.growthRate}
                        </p>
                      </div>
                      <div className="p-4 bg-gray-700/20 rounded-lg">
                        <p className="text-sm text-gray-400">TAM</p>
                        <p className="text-gray-300 font-medium">
                          {results.marketAnalysis.tam}
                        </p>
                      </div>
                      <div className="p-4 bg-gray-700/20 rounded-lg">
                        <p className="text-sm text-gray-400">SAM</p>
                        <p className="text-gray-300 font-medium">
                          {results.marketAnalysis.sam}
                        </p>
                      </div>
                      <div className="p-4 bg-gray-700/20 rounded-lg">
                        <p className="text-sm text-gray-400">SOM</p>
                        <p className="text-gray-300 font-medium">
                          {results.marketAnalysis.som}
                        </p>
                      </div>
                    </div>
                    <div className="mt-6">
                      <h5 className="text-md font-semibold text-emerald-400 mb-2">
                        Trends
                      </h5>
                    ...
                    <div className="mt-4">
                      ...
                      <ul className="list-disc ml-5 space-y-1 text-gray-300 text-sm">
                        {results.marketAnalysis.competitors.map(
                          (comp, index) => (
                    ...
                    <div className="mt-4">
                      ...
                      <ul className="list-disc ml-5 space-y-1 text-gray-300 text-sm">
                        {results.marketAnalysis.customerNeeds.map(
                          (need, index) => (
                    ...
                    <div className="mt-4">
                      ...
                      <ul className="list-disc ml-5 space-y-1 text-gray-300 text-sm">
                        {results.marketAnalysis.barriersToEntry.map(
                          (barrier, index) => (
